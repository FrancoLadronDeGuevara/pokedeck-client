        ...
        <Container disableGutters>
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                ...
                <Box maxWidth='md' sx={{ height: {xs: 350, sm: 200}}}>
                    <BottomNavigation
                    sx={{display: 'flex', flexWrap: 'wrap', width: {xs: 300, sm: 550}}}
                        showLabels
                        value={value}
                        onChange={(e, newValue) => {
                            setValue(newValue);
            ...
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ px: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
