...
const AllUsers = () => {
    ...
    const rows = users && users.map(user => createData(user.username, user.avatar.url, user.disabled, user.userDeck, user.coins, user.email, user.createdAt, user.role, user._id))
