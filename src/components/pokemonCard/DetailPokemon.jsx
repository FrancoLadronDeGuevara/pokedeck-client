...
const DetailPokemon = ({
  ...
  const handleSellCard = () => {
    ...
    customAlert(`¿Vender esta carta por ₽${price}?`, () => {
      dispatch(sellCard(data))
        .then(() => {
          autoCloseAlert("Carta Vendida", "success");
        ...
        >
          <button
            className={`sell-button ${
              hideButton ? "hide-button" : "show-button"
            }`}
